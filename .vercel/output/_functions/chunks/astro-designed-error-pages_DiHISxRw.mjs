import { ap as NOOP_MIDDLEWARE_HEADER, aq as REDIRECT_STATUS_CODES, A as AstroError, ar as ActionsReturnedInvalidDataError, _ as DEFAULT_404_COMPONENT } from './astro/server_Bc-coSIJ.mjs';
...
function serializeActionResult(res) {
  if (res.error) {
    if (Object.assign(__vite_import_meta_env__, { endpoint: "http://0.0.0.0:8055/items/", _: process.env._ })?.DEV) {
...
function deserializeActionResult(res) {
  if (res.type === "error") {
    ...
    if (Object.assign(__vite_import_meta_env__, { endpoint: "http://0.0.0.0:8055/items/", _: process.env._ })?.PROD) {
