...
</p> <div class="space-y-4 pt-4" data-astro-cid-ikzcxylh> <div class="flex gap-3" data-astro-cid-ikzcxylh> <span class="font-semibold" data-astro-cid-ikzcxylh>E-mail:</span> <span data-astro-cid-ikzcxylh>${contactInfo.email}</span> </div> <div class="flex gap-3" data-astro-cid-ikzcxylh> <span class="font-semibold" data-astro-cid-ikzcxylh>Ph. no:</span> <span data-astro-cid-ikzcxylh>${contactInfo.phone}</span> </div> </div> </div> <!-- FORM --> <div class="w-full" data-astro-cid-ikzcxylh> <h3 class="text-2xl font-bold mb-6" data-astro-cid-ikzcxylh>Schedule Your Assessment</h3> <form id="contact-form" class="space-y-5" data-astro-cid-ikzcxylh> <div data-astro-cid-ikzcxylh> <label class="block text-sm font-medium mb-1" data-astro-cid-ikzcxylh>Name</label> <input name="name" required placeholder="Your Name" class="w-full px-4 py-3 border rounded-lg" data-astro-cid-ikzcxylh> </div> <div class="grid grid-cols-1 sm:grid-cols-2 gap-4" data-astro-cid-ikzcxylh> <div data-astro-cid-ikzcxylh> <label class="block text-sm font-medium mb-1" data-astro-cid-ikzcxylh>Phone Number</label> <input name="phone_number" required placeholder="Your Phone No." class="w-full px-4 py-3 border rounded-lg" data-astro-cid-ikzcxylh> </div> <div data-astro-cid-ikzcxylh> <label class="block text-sm font-medium mb-1" data-astro-cid-ikzcxylh>Preferred Date</label> <input type="date" name="Preferred_Date" required class="w-full px-4 py-3 border rounded-lg" data-astro-cid-ikzcxylh> </div> </div> <div class="grid grid-cols-1 sm:grid-cols-2 gap-4" data-astro-cid-ikzcxylh> <div data-astro-cid-ikzcxylh> <label class="block text-sm font-medium mb-1" data-astro-cid-ikzcxylh>Time Slot</label> <select name="slots" required class="w-full px-4 py-3 border rounded-lg bg-white" data-astro-cid-ikzcxylh> <option value="" data-astro-cid-ikzcxylh>Select Time Slot</option> ${timeSlots.map((slot, index) => {
